...
FILENAMES = "/home/ganesh/career/gsoc/dataset/audioset_laughter_clips/10secondclipfiles.txt"
DATASET_LOCATION = "/home/ganesh/career/gsoc/dataset/audioset_laughter_clips/"
with open(FILENAMES,"r") as fh:
    filecontents=fh.read()
    filenames=filecontents.split('\n')
    filenames = [DATASET_LOCATION+f for f in filenames]

filenames.pop(filenames.index('/home/ganesh/career/gsoc/dataset/audioset_laughter_clips/'))
